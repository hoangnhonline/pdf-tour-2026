    ...
    <main>
        <div style="text-align: center; margin-bottom: 30px;">
            <h1 class="title-general">
                VIETNAM HIGHLIGHTS: HANOI – DA NANG – PHU QUOC
            </h1>
      ...
      <!--   <div class="section-header">Traveller Details</div>ITINERARY
        ...
        <table class="data-table" style="margin-bottom: 450px;">
            ...
            <tbody>
                ...
                <tr style="background-color: #faf5ff;">
                    ...
                    <td><strong style="color: #6b21a8;">INR 32,160/per person</strong></td>
                </tr>                
            </tbody>
        </table>
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">HANOI ARRIVAL & CITY IMMERSION (Lunch included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        <span class="activity-title">Airport Pickup:</span>
                        <p class="activity-desc">
                            Warm welcome at Noi Bai International Airport followed by a private transfer to your hotel for check-in.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Hanoi City Tour:</span>
                        <p class="activity-desc">
                            Discover the capital’s rich cultural heritage and iconic landmarks, accompanied by an experienced English-speaking tour guide. Enjoy an authentic local lunch during the tour.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Evening:</span>
                        <p class="activity-desc">
                            Return to the hotel. Enjoy your evening at leisure to explore Hanoi's vibrant Old Quarter at your own pace.
                        </p>
                    </li>
                </ul>
                <table class="day-gallery-table">
                    <tr>
                        <td>
                            <img src="images/hn1.jpg" class="day-gallery-img" alt="Day image 1">
                        </td>
                        <td>
                            <img src="images/hn4.jpg" class="day-gallery-img" alt="Day image 2">
                        </td>
                        <td>
                            <img src="images/hn3.jpg" class="day-gallery-img" alt="Day image 3">
                        </td>
                        <td>
                            <img src="images/hn2.jpg" class="day-gallery-img" alt="Day image 4">
                        </td>
                    </tr>
                </table>
                ...
                <div class="day-summary-footer">
                    ...
                    Accommodation, Shared (SIC) airport transfer, City tour (SIC), Tickets to visit scenic spots, Lunch<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
                    Dinner, drinks, personal expenses, International flight ticket India - Ha Noi
                </div>
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">HANOI – FLY TO DA NANG & HAN RIVER CRUISE (Breakfast included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        <span class="activity-title">Morning:</span>
                        <p class="activity-desc">
                            Breakfast at the hotel, check-out, and private transfer to the airport for your domestic flight to Da Nang.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Da Nang Arrival:</span>
                        <p class="activity-desc">
                            Arrive in Da Nang and transfer to the hotel for check-in.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Evening Highlight:</span>
                        <p class="activity-desc">
                            Embark on a memorable Han River party cruise, soaking in the shimmering skyline and iconic bridges. Transfer back to the hotel afterwards.
                        </p>
                    </li>
                ...
                <table class="day-gallery-table">
                    <tr>
                        <td>
                            <img src="images/40.jpg" class="day-gallery-img" alt="Day image 1">
                        </td>
                        <td>
                            <img src="images/41.jpg" class="day-gallery-img" alt="Day image 2">
                        </td>
                        <td>
                            <img src="images/42.jpg" class="day-gallery-img" alt="Day image 3">
                        </td>
                        <td>
                            <img src="images/43.jpg" class="day-gallery-img" alt="Day image 4">
                        </td>
                    </tr>
                </table>
                <!-- Inclusions & Exclusions Summary Bar -->
                <div class="day-summary-footer">
                    ...
                    Breakfast, Shared (SIC) airport transfer, Shared transfer from hotel to the cruise harbor, Han River Party Cruise Tour on SIC basis, Domestic flight ticket from Hanoi to Da Nang
<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
                    Domestic flight ticket, Lunch, Dinner, Tour guide, Personal expenses
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">BA NA HILLS – GOLDEN BRIDGE & NIGHTLIFE (Breakfast & Lunch included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        <span class="activity-title">Morning:</span>
                        <p class="activity-desc">
                            Breakfast at the hotel followed by a private transfer to the famous Ba Na Hills mountain resort.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Sightseeing & Lunch:</span>
                        <p class="activity-desc">
                            Ride the world-record cable car to explore the iconic Golden Bridge, French Village, and various recreational amenities. Savor a delicious international buffet lunch at a hilltop restaurant
                        </p>
                    </li>
                    ...
                    <li class="activity-item">
                        <span class="activity-title">Evening:</span>
                        <p class="activity-desc">
                            Return to the hotel in the late afternoon. Enjoy your evening at leisure to experience Da Nang's bustling nightlife.
                        </p>
                    </li>
                </ul>
                <table class="day-gallery-table">
                    <tr>
                        <td>
                            <img src="images/dn1.jpg" class="day-gallery-img" alt="Day image 1">
                        </td>
                        <td>
                            <img src="images/dn3.jpg" class="day-gallery-img" alt="Day image 3">
                        </td>
                        <td>
                            <img src="images/dn2.jpg" class="day-gallery-img" alt="Day image 2">
                        </td>
                        
                        <td>
                            <img src="images/dn4.jpg" class="day-gallery-img" alt="Day image 4">
                        </td>
                    </tr>
                </table>
                <!-- Inclusions/Exclusions Summary Bar -->                
                <div class="day-summary-footer">
                    ...
                    Breakfast, Ba Na Hills Tour on SIC basis, Buffet lunch at an Indian restaurant
<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">DA NANG – FLY TO PHU QUOC & VINWONDERS ATTRACTIONS (Breakfast & Dinner included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        <span class="activity-title">Morning:</span>
                        <p class="activity-desc">
                            Breakfast, check-out, and transfer to the airport for your flight to the tropical paradise of Phu Quoc.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">VinWonders Excursion:</span>
                        <p class="activity-desc">
                            Private transfer directly to VinWonders Phu Quoc—Vietnam's premier theme park featuring the world-class Sea Shell Aquarium (the largest turtle-shaped oceanarium in Southeast Asia).
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Evening Experience:</span>
                        <p class="activity-desc">
                            Transfer to the bustling Phu Quoc Night Market, followed by an authentic Indian dinner at a local restaurant before checking in at your hotel.
                        </p>
                    </li>
                </ul>
                <table class="day-gallery-table">
                    <tr>
                        <td>
                            <img src="images/4.jpg" class="day-gallery-img" alt="Day image 1">
                        </td>
                        <td>
                            <img src="images/5.jpg" class="day-gallery-img" alt="Day image 3">
                        </td>
                        <td>
                            <img src="images/6.jpg" class="day-gallery-img" alt="Day image 2">
                        </td>
                        
                        <td>
                            <img src="images/7.jpg" class="day-gallery-img" alt="Day image 4">
                        </td>
                    </tr>
                </table>
                <!-- Inclusions/Exclusions Summary Bar -->                
                <div class="day-summary-footer">
                    ...
                    Breakfast, Domestic flight from Da Nang to Phu Quoc, Shared (SIC) airport transfer, Shared round-trip transfer to VinWonders Phu Quoc, VinWonders Phu Quoc entrance ticket, Transfer to Phu Quoc Night Market, Dinner at an Indian restaurant
<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
                   Domestic flight ticket, Lunch, Tour guide, Personal expenses.
                </div>
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">PHU QUOC ISLAND-HOPPING & SNORKELING ADVENTURE (Breakfast & Lunch included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    <li class="activity-item">
                        <span class="activity-title">Full-Day Excursion:</span>
                        <p class="activity-desc">
                            Embark on a scenic island-hopping boat tour with crystal-clear waters, guided by a dedicated Indian tour guide.
                        </p>
                    </li>

                    <li class="activity-item">
                        <span class="activity-title">Highlights:</span>
                        <p class="activity-desc">
                            Enjoy world-class snorkeling among coral reefs and savor a freshly prepared Indian meal served on board.
                        </p>
                    </li>
                    ...
                    <li class="activity-item">
                        <span class="activity-title">Evening:</span>
                        <p class="activity-desc">
                            Return to the hotel in the late afternoon. Enjoy your final evening at leisure on the island.
                        </p>
                    </li>
                </ul>
                <table class="day-gallery-table">
                    <tr>
                        <td>
                            <img src="images/9.jpeg" class="day-gallery-img" alt="Day image 1">
                        </td>
                        <td>
                            <img src="images/10.jpg" class="day-gallery-img" alt="Day image 3">
                        </td>
                        <td>
                            <img src="images/11.jpeg" class="day-gallery-img" alt="Day image 2">
                        </td>
                        
                        <td>
                            <img src="images/12.jpg" class="day-gallery-img" alt="Day image 4">
                        </td>
                    </tr>
                </table>
                <!-- Inclusions/Exclusions Summary Bar -->               
                <div class="day-summary-footer">
                    ...
                    Breakfast, Private island-hopping and snorkeling tour by boat, Indian lunch served on the boat<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
                    Dinner, drinks, personal expenses.
        ...
        <div class="day-block">
            ...
            <div class="day-header">
                ...
                <h3 class="day-title">PHU QUOC DEPARTURE (Breakfast included)</h3>
            </div>
            ...
            <div class="day-body">
                ...
                <ul class="activity-list">
                    ...
                    <li class="activity-item">
                        <span class="activity-title">Airport Drop-off:</span>
                        <p class="activity-desc">
                            Private transfer to Phu Quoc International Airport for your departure flight. End of services.
                        </p>
                    </li>
                </ul>
                ...
                <div class="day-summary-footer">
                    ...
                    Breakfast, Shared (SIC) airport transfer.<br>
                    <span class="inc-label">
                        <img src="images/tick-2.png" class="status-icon" alt="Included"> Exclusions:
                    </span>
                    Lunch, Dinner, Personal expenses, International flight ticket from Phu Quoc to India
                </div>
        ...
        <div class="exclusions-section">
            ...
            <ul class="exclusions-list">
                <li><strong>Airfare:</strong> International flights, Domestic flights (unless specifically mentioned in day inclusions).</li>
